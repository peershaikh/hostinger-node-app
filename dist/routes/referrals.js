...
router.post('/apply', authMiddleware_1.requireAuth, rateLimiter_1.referralLimiter, (0, validateSchema_1.validateBody)(appSchemas_1.referralCodeSchema), referralController_1.referralController.apply.bind(referralController_1.referralController));
