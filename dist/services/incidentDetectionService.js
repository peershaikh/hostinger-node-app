...
exports.incidentDetectionService = exports.IncidentDetectionService = void 0;
...
class IncidentDetectionService {
    ...
    async getIncidentReport() {
        ...
        try {
            ...
            logger_1.winstonLogger.warn(`[INCIDENT_SERVICE] Payment query error: ${err.message}`);
        }
...
exports.IncidentDetectionService = IncidentDetectionService;
exports.incidentDetectionService = new IncidentDetectionService();
