...
import { BookingIntent, PartnerAttribution, ProviderId } from './interfaces';
...
function generateClickId(sessionId: string): string {
...
function generatePartnerSessionId(provider: ProviderId): string {
 ...
 */
export function generateAttribution(intent: BookingIntent): PartnerAttribution {
 ...
 */
export function attributionToQueryString(attribution: PartnerAttribution): string {
